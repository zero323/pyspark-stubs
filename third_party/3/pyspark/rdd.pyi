...
class RDD(Generic[T]):
    ...
    @overload
    def groupWith(self: RDD[Tuple[K, V]], other1: RDD[Tuple[K, V1]], other2: RDD[Tuple[K, V2]], other3: RDD[Tuple[K, V3]]) -> RDD[Tuple[K, Tuple[ResultIterable[V], ResultIterable[V1], ResultIterable[V2], ResultIterable[V3]]]]: ...
    def cogroup(self: RDD[Tuple[K, V]], other: RDD[Tuple[K, U]], numPartitions: Optional[int] = ...) -> RDD[Tuple[K, Tuple[ResultIterable[V], ResultIterable[U]]]]: ...

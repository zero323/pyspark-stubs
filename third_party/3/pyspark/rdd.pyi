...
class RDD(Generic[T]):
    ...
    def map(
        self, f: Callable[[T], U], preservesPartitioning: bool = ...
    ) -> "RDD[U]": ...
    def flatMap(
    ...
    def repartitionAndSortWithinPartitions(
        ...
        ascending: bool = ...,
        keyfunc: Callable[[K], Any] = ...,
    ) -> "RDD[Tuple[K, V]]": ...
    def sortByKey(
        self: "RDD[Tuple[K, V]]",
        ascending: bool = ...,
        numPartitions: Optional[int] = ...,
        keyfunc: Callable[[Any], int] = ...,
    ) -> "RDD[Tuple[K, V]]": ...
    def sortBy(
        self,
    ...
    def takeOrdered(
        self, num: int, key: Optional[Callable[[T], Any]] = ...
    ) -> List[T]: ...
    ...
    def saveAsHadoopDataset(
        self: "RDD[Tuple[K, V]]",
        conf,
        keyConverter: Optional[Any] = ...,
        valueConverter: Optional[Any] = ...,
    ): ...
    ...
    def mapValues(
        self: "RDD[Tuple[K, V]]", f: Callable[[V], U]
    ) -> "RDD[Tuple[K, U]]": ...
    @overload
    def groupWith(
    ...
    ) -> "RDD[Tuple[K, Tuple[ResultIterable[V], ResultIterable[V1], List[V2], ResultIterable[V3]]]]": ...
    def cogroup(
        self: "RDD[Tuple[K, V]]",
        other: "RDD[Tuple[K, V1]]",
        numPartitions: Optional[int] = ...,
    ) -> "RDD[Tuple[K, Tuple[List[V], List[V1]]]]": ...
    def sampleByKey(
        self: "RDD[Tuple[K, V]]",

...
class RDD(Generic[T]):
    ...
    def mapPartitions(self, f: Callable[[Iterator[T]], Iterator[U]], preservesPartitioning: bool = ...) -> RDD[U]: ...
    def mapPartitionsWithIndex(self, f: Callable[[int, Iterator[T]], Iterator[U]], preservesPartitioning: bool = ...) -> RDD[U]: ...
    def mapPartitionsWithSplit(self, f: Callable[[int, Iterator[T]], Iterator[U]], preservesPartitioning: bool = ...) -> RDD[U]: ...

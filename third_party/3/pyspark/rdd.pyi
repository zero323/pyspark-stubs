...
class RDD(Generic[T]):
    ...
    def repartitionAndSortWithinPartitions(self: 'RDD[Tuple[K, V]]', numPartitions: Optional[int] = ..., partitionFunc: Callable[[Any], int] = ..., ascending: bool = ..., keyfunc: Callable[[K], Any] = ...) -> 'RDD[Tuple[K, V]]': ...
    def sortByKey(self: 'RDD[Tuple[K, V]]', ascending: bool = ..., numPartitions: Optional[int] = ..., keyfunc: Callable[[Any], int] = ...) -> 'RDD[Tuple[K, V]]': ...
    def sortBy(self, keyfunc: 'Callable[[T], Any]', ascending: bool = ..., numPartitions: Optional[int] = ...) -> 'RDD[T]': ...
    def glom(self) -> 'RDD[List[T]]': ...
    def cartesian(self, other: 'RDD[U]') -> 'RDD[Tuple[T, U]]': ...
    def groupBy(self, f: Callable[[T], K] , numPartitions: Optional[int] = ..., partitionFunc: Callable[[Any], int] = ...) -> 'RDD[Tuple[K, Iterable[T]]]': ...
    ...
    def max(self, key: Optional[Callable[[T], Any]] = ...) -> T: ...
    def min(self, key: Optional[Callable[[T], Any]] = ...) -> T: ...
    ...
    def countByValue(self) -> Dict[T, int]: ...
    def top(self, num: int, key: Optional[Callable[[T], Any]] = ...) -> List[T]: ...
    def takeOrdered(self, num: int, key: Optional[Callable[[T], Any]] = ...) -> List[T]: ...
    ...
    def saveAsHadoopDataset(self: 'RDD[Tuple[K, V]]', conf, keyConverter: Optional[Any] = ..., valueConverter: Optional[Any] = ...): ...
    ...
    def reduceByKey(self: 'RDD[Tuple[K, V]]', func: Callable[[V, V], V], numPartitions: Optional[int] = ..., partitionFunc: Callable[[Any], int] = ...) -> 'RDD[Tuple[K, V]]': ...
    ...
    def partitionBy(self: 'RDD[Tuple[K, V]]', numPartitions: int, partitionFunc: Callable[[Any], int] = ...) -> 'RDD[Tuple[K, V]]': ...
    def combineByKey(self: 'RDD[Tuple[K, V]]', createCombiner: Callable[[V], U], mergeValue: Callable[[U, V], U], mergeCombiners: Callable[[U, U], U], numPartitions: Optional[int] = ..., partitionFunc: Callable[[Any], int] = ...) -> 'RDD[Tuple[K, U]]': ...
    def aggregateByKey(self: 'RDD[Tuple[K, V]]', zeroValue: U, seqFunc: Callable[[U, V], U], combFunc: Callable[[U, U], U], numPartitions: Optional[int] = ..., partitionFunc: Callable[[Any], int] = ...) -> 'RDD[Tuple[K, U]]': ...
    def foldByKey(self: 'RDD[Tuple[K, V]]', zeroValue: V, func: Callable[[V, V], V], numPartitions: Optional[int] = ..., partitionFunc: Callable[[Any], int] = ...) -> 'RDD[Tuple[K, V]]': ...
    def groupByKey(self: 'RDD[Tuple[K, V]]', numPartitions: Optional[int] = ..., partitionFunc: Callable[[Any], int] = ...) -> 'RDD[Tuple[K, Iterable[V]]]': ...
    ...
    @overload
    def groupWith(self: 'RDD[Tuple[K, V]]', __o: 'RDD[Tuple[K, V1]]') -> 'RDD[Tuple[K, Tuple[ResultIterable[V], ResultIterable[V1]]]]': ...
    @overload
    def groupWith(self: 'RDD[Tuple[K, V]]', __o1: 'RDD[Tuple[K, V1]]', __o2: 'RDD[Tuple[K, V2]]') -> 'RDD[Tuple[K, Tuple[ResultIterable[V], ResultIterable[V1], ResultIterable[V2]]]]': ...
    @overload
    def groupWith(self: 'RDD[Tuple[K, V]]', other1: 'RDD[Tuple[K, V1]]', other2: 'RDD[Tuple[K, V2]]', other3: 'RDD[Tuple[K, V3]]') -> 'RDD[Tuple[K, Tuple[ResultIterable[V], ResultIterable[V1], List[V2], ResultIterable[V3]]]]': ...

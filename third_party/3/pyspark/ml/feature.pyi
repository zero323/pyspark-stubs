...
class StringIndexer(JavaEstimator[StringIndexerModel], _StringIndexerParams, JavaMLReadable[StringIndexer], JavaMLWritable):
    def __init__(self, inputCol: Optional[str] = ..., outputCol: Optional[str] = ..., inputCols: Optional[List[str]] = ..., outputCols: Optional[List[str]] = ..., handleInvalid: str = ..., stringOrderType: str = ...) -> None: ...
    def setParams(self, inputCol: Optional[str] = ..., outputCol: Optional[str] = ..., inputCols: Optional[List[str]] = ..., outputCols: Optional[List[str]] = ..., handleInvalid: str = ..., stringOrderType: str = ...) -> StringIndexer: ...

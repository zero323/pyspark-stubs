...
class Param(Generic[T]):
    ...
    def __init__(self, parent: pyspark.ml.util.Identifiable, name: str, doc: str, typeConverter: Optional[Callable[[Any], T]] = ...) -> None: ...
...
class Params(pyspark.ml.util.Identifiable):
    ...
    def extractParamMap(self, extra: Optional[pyspark.ml._typing.ParamMap] = ...) -> pyspark.ml._typing.ParamMap: ...

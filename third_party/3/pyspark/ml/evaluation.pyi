...
class BinaryClassificationEvaluator(
    JavaEvaluator, HasLabelCol, HasRawPredictionCol, JavaMLReadable, JavaMLWritable
):
    metricName = ...  # type: Param
    def __init__(
        self, *, rawPredictionCol: str = ..., labelCol: str = ..., metricName: str = ...
    ) -> None: ...
...
class RegressionEvaluator(
    ...
    metricName = ...  # type: Param
    def __init__(
        self, *, predictionCol: str = ..., labelCol: str = ..., metricName: str = ...
    ) -> None: ...
...
class ClusteringEvaluator(
    JavaEvaluator, HasPredictionCol, HasFeaturesCol, JavaMLReadable, JavaMLWritable
):
    metricName = ...  # type: Param
    def __init__(
        self, *, predictionCol: str = ..., featuresCol: str = ..., metricName: str = ...
    ) -> None: ...

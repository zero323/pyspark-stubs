...
class FMRegressor(JavaPredictor, _FactorizationMachinesParams, JavaMLWritable, JavaMLReadable):
    ...
    initStd: Any = ...
    solver: Any = ...
    def __init__(self, featuresCol: str = ..., labelCol: str = ..., predictionCol: str = ..., factorSize: int = ..., fitIntercept: bool = ..., fitLinear: bool = ..., regParam: float = ..., miniBatchFraction: float = ..., initStd: float = ..., maxIter: int = ..., stepSize: float = ..., tol: float = ..., solver: str = ..., seed: Optional[Any] = ...) -> None: ...
    def setParams(self, featuresCol: str = ..., labelCol: str = ..., predictionCol: str = ..., factorSize: int = ..., fitIntercept: bool = ..., fitLinear: bool = ..., regParam: float = ..., miniBatchFraction: float = ..., initStd: float = ..., maxIter: int = ..., stepSize: float = ..., tol: float = ..., solver: str = ..., seed: Optional[Any] = ...): ...
    def setFactorSize(self, value: Any): ...
    def setFitLinear(self, value: Any): ...
    def setMiniBatchFraction(self, value: Any): ...
    def setInitStd(self, value: Any): ...
    def setMaxIter(self, value: Any): ...
    def setStepSize(self, value: Any): ...
    def setTol(self, value: Any): ...
    def setSolver(self, value: Any): ...
    def setSeed(self, value: Any): ...
    def setFitIntercept(self, value: Any): ...
    def setRegParam(self, value: Any): ...

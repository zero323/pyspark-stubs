...
class Column:
    ...
    def __truediv__(
        self, other: Union[Column, Literal, DecimalLiteral]
    ) -> "Column": ...
    def __mod__(self, other: Union[Column, Literal, DecimalLiteral]) -> "Column": ...
    def __radd__(self, other: Union[Literal, DecimalLiteral]) -> "Column": ...
    def __rsub__(self, other: Union[Literal, DecimalLiteral]) -> "Column": ...
    def __rmul__(self, other: Union[Literal, DecimalLiteral]) -> "Column": ...
    def __rdiv__(self, other: Union[Literal, DecimalLiteral]) -> "Column": ...
    def __rtruediv__(self, other: Union[Literal, DecimalLiteral]) -> "Column": ...
    ...
    def __rpow__(self, other: Union[Literal, DecimalLiteral]) -> "Column": ...
    def __eq__(self, other: Union[Column, Literal, DecimalLiteral]) -> "Column": ...  # type: ignore
    def __ne__(self, other: Any) -> "Column": ...  # type: ignore
    def __lt__(self, other: Union[Column, Literal, DecimalLiteral]) -> "Column": ...
    def __le__(self, other: Union[Column, Literal, DecimalLiteral]) -> "Column": ...
    def __ge__(self, other: Union[Column, Literal, DecimalLiteral]) -> "Column": ...
    def __gt__(self, other: Union[Column, Literal, DecimalLiteral]) -> "Column": ...

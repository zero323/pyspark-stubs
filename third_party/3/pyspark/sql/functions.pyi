...
def lag(
    col: ColumnOrName, count: int = ..., default: Optional[Any] = ...
) -> Column: ...
def lead(
    col: ColumnOrName, count: int = ..., default: Optional[Any] = ...
) -> Column: ...
...
def split(str: ColumnOrName, pattern: str) -> Column: ...
...
def from_json(
    col: ColumnOrName,
    schema: Union[ArrayType, MapType, StructType, Column, str],
...
@overload
def pandas_udf(
    f: PandasScalarFunction,
    returnType: Union[AtomicDataTypeOrString, ArrayType],
    functionType: PandasScalarUDFType,
) -> UserDefinedFunctionLike: ...
@overload
def pandas_udf(
    f: Union[AtomicDataTypeOrString, ArrayType], returnType: PandasScalarUDFType
) -> Callable[[PandasScalarFunction], UserDefinedFunctionLike]: ...
@overload
def pandas_udf(
    f: Union[AtomicDataTypeOrString, ArrayType], *, functionType: PandasScalarUDFType
) -> Callable[[PandasScalarFunction], UserDefinedFunctionLike]: ...
@overload
def pandas_udf(
    *,

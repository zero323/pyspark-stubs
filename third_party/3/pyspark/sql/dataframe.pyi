...
class DataFrame(PandasMapOpsMixin, PandasConversionMixin):
    ...
    def explain(
        self, extended: Optional[bool] = ..., mode: Optional[str] = ...
    ) -> None: ...
    ...
    def sampleBy(
        self, col: str, fractions: float, seed: Optional[int] = ...
    ) -> DataFrame: ...
    def randomSplit(
    ...
    def filter(self, condition: Union[ColumnOrName, bool]) -> DataFrame: ...
    @overload
    ...
    def where(self, condition: Union[ColumnOrName, bool]) -> DataFrame: ...

...
from pyspark.sql._typing import ColumnOrName, LiteralType, PandasMapIterUserDefinedFunctionLike
...
class DataFrame:
    ...
    def mapInPandas(self, udf: PandasMapIterUserDefinedFunctionLike) -> DataFrame: ...
